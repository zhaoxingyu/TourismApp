...
import com.nostra13.universalimageloader.cache.memory.impl.NativefLruMemoryCache;
...
public class DefaultConfigurationFactory {
	...
	public static MemoryCache createMemoryCache(int memoryCacheSize) {
		if (memoryCacheSize == 0) {
			memoryCacheSize = (int) (Runtime.getRuntime().totalMemory() / 4);
		}
		return new LruMemoryCache(memoryCacheSize);
	}

    public static NativeMemoryCache createNativeMemoryCache(int nativeMemoryCacheSize) {
        if (nativeMemoryCacheSize == 0) {
            nativeMemoryCacheSize = (int) (Runtime.getRuntime().totalMemory() / 4);
        }
        return new NativefLruMemoryCache(nativeMemoryCacheSize);
    }
