...
public final class DisplayImageOptions {
	...
	private final boolean cacheInNativeMemory;
	...
	private DisplayImageOptions(Builder builder) {
		...
		cacheInNativeMemory = builder.cacheInNativeMemory;
	...
	public boolean isCacheInNativeMemory() {
	    return cacheInNativeMemory;
	}
	...
	public static class Builder {
		...
		private boolean cacheInNativeMemory = true;
		...
		/** Sets whether loaded image will be cached in native memory */
		public Builder cacheInNativeMemory(boolean cacheInNativeMemory) {
		    this.cacheInNativeMemory = cacheInNativeMemory;
		    return this;
		}
