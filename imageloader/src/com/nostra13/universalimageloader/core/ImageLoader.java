...
import com.nostra13.universalimageloader.core.listener.ImageLoadingProgressListener2;
...
public class ImageLoader {
    ...
    /**
     * Returns native memory cache
     *
     * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called before
     */
    public NativeMemoryCache getNativeMemoryCache() {
        checkConfiguration();
        return configuration.nativeMemoryCache;
    }
    ...
    /**
     * Clears native memory cache
     *
     * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called before
     */
    public void clearNativeMemoryCache() {
        checkConfiguration();
        configuration.nativeMemoryCache.clear();
    }
    ...
    public String loadImageSync(String uri, DiskCacheFolder folder, ImageLoadingProgressListener2 listener) {
        ...
        DisplayImageOptions options = new DisplayImageOptions.Builder().diskCacheSubDir(folder).build();
    ...
    public String loadImageSync(String uri, ImageLoadingListener listener, ImageLoadingProgressListener progressListener,
        ...
        options = new DisplayImageOptions.Builder().cloneFrom(options).cacheInMemory(false).cacheInNativeMemory(false).syncLoading(true).build();
