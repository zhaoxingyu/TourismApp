...
public final class ImageLoaderConfiguration {
	...
	final Executor taskExecutorForRealTime;
	final Executor taskExecutorForCachedImages;
	final boolean customExecutor;
	final boolean customExecutorForCachedImages;
	final boolean customExecutorForRealTime;
	...
	final NativeMemoryCache nativeMemoryCache;
	...
	private ImageLoaderConfiguration(final Builder builder) {
		...
		taskExecutorForRealTime = builder.taskExecutorForRealTime;
		...
		nativeMemoryCache = builder.nativeMemoryCache;
		...
		customExecutorForRealTime = builder.customExecutorForRealTime;
	...
	public static class Builder {
		...
		private Executor taskExecutorForRealTime = null;
		private Executor taskExecutorForCachedImages = null;
		private boolean customExecutor = false;
		private boolean customExecutorForCachedImages = false;
		private boolean customExecutorForRealTime = false;
		...
		private int nativeMemoryCacheSize = 0;
		private long diskCacheSize = 0;
		private int diskCacheFileCount = 0;

		private MemoryCache memoryCache = null;
		private NativeMemoryCache nativeMemoryCache = null;
		...
		public Builder taskExecutorForRealTime(Executor executor) {
		    this.taskExecutorForRealTime = executor;
		    return this;
		}
		...
		public Builder nativeMemoryCacheSize(int nativeMemoryCacheSize) {
		    if (nativeMemoryCacheSize <= 0) throw new IllegalArgumentException("memoryCacheSize must be a positive number");
		    
		    if (nativeMemoryCache != null) {
		        L.w(WARNING_OVERLAP_MEMORY_CACHE);
		    }
		    
		    this.nativeMemoryCacheSize = nativeMemoryCacheSize;
		    return this;
		}
		...
		public Builder nativeMemoryCache(NativeMemoryCache nativeMemCache) {
		    if (memoryCacheSize != 0) {
		        L.w(WARNING_OVERLAP_MEMORY_CACHE);
		    }
		    
		    this.nativeMemoryCache = nativeMemCache;
		    return this;
		}
		...
		private void initEmptyFieldsWithDefaultValues() {
			...
			if (taskExecutorForRealTime == null) {
			    taskExecutorForRealTime = DefaultConfigurationFactory.createRealTimeTask();
			} else {
			    customExecutorForRealTime = true;
			}
			...
			if (nativeMemoryCache == null) {
			    nativeMemoryCache = DefaultConfigurationFactory.createNativeMemoryCache(nativeMemoryCacheSize);
			}
