...
class ImageLoaderEngine {
	...
	private Executor taskExecutorForRealTime;
	...
	ImageLoaderEngine(ImageLoaderConfiguration configuration) {
		...
		taskExecutorForRealTime = configuration.taskExecutorForRealTime;
			...
			public void run() {
				...
				if (isImageCachedOnDisk) {
				    ...
				    if (task.options.inRealTime()) {
				        taskExecutorForRealTime.execute(task);
                    } else {
	...
	private void initExecutorsIfNeed() {
        ...
        if (!configuration.customExecutorForRealTime && ((ExecutorService) taskExecutorForRealTime).isShutdown()) {
            taskExecutorForRealTime = createRealTimeTask();
        }
	}
	...
	private Executor createRealTimeTask() {
	    return DefaultConfigurationFactory.createRealTimeTask();
	}
	...
	void stop() {
		...
		if (!configuration.customExecutorForRealTime) {
		    ((ExecutorService) taskExecutorForRealTime).shutdownNow();
		}
